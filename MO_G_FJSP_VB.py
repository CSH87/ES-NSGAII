...
import random
import numpy as np
from Class_define_ESNSGA_VB import myProblem
from Class_define_ESNSGA_VB import myEvolution
#%%
...
if __name__ == '__main__' :
    ...
    print("Evolutioin......") 
    evo = myEvolution(problem, num_of_generations=20, num_of_individuals=1000, mutation_schedule=[[0,120],[100,100],[200,80],[300,60],[400,40],[500,20],[600,10]])
    evol = evo.evolve()
    func=[]
    feature=[]
